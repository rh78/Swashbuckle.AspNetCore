...
namespace Swashbuckle.AspNetCore.ApiTesting.Test
{
    public class RequestValidatorTests
    {
            ...
            string expectedErrorMessage)
        {
            ...
            {
                Subject().Validate(pathTemplate, OperationType.Get, openApiDocument, request);
            });
            ...
            string expectedErrorMessage)
        {
            ...
            var exception = Record.Exception(() =>
            {
                Subject().Validate("/api/products", operationType, openApiDocument, request);
            });
            ...
            string expectedErrorMessage)
        {
            ...
            var exception = Record.Exception(() =>
            {
                Subject().Validate("/api/products", OperationType.Get, openApiDocument, request);
            });
            ...
            string expectedErrorMessage)
        {
            ...
            var exception = Record.Exception(() =>
            {
                Subject().Validate("/api/products/{param}", OperationType.Get, openApiDocument, request);
            });
            ...
            string expectedErrorMessage)
        {
            ...
            var exception = Record.Exception(() =>
            {
                Subject().Validate("/api/products", OperationType.Post, openApiDocument, request);
            });
            ...
            string expectedErrorMessage)
        {
            ...
            var exception = Record.Exception(() =>
            {
                Subject(new[] { new JsonContentValidator() }).Validate("/api/products", OperationType.Post, openApiDocument, request);
            });
