...
namespace Swashbuckle.AspNetCore.ApiTesting.Test
{
    public class ResponseValidatorTests
    {
            ...
            string expectedErrorMessage)
        {
            ...
            {
                Subject().Validate("/api/products", OperationType.Get, "200", openApiDocument, response);
            });
            ...
            string expectedErrorMessage)
        {
            ...
            var exception = Record.Exception(() =>
            {
                Subject().Validate("/api/products", OperationType.Post, "201", openApiDocument, response);
            });
            ...
            string expectedErrorMessage)
        {
            ...
            var exception = Record.Exception(() =>
            {
                Subject().Validate("/api/products/1", OperationType.Get, "200", openApiDocument, response);
            });
            ...
            string expectedErrorMessage)
        {
            ...
            var exception = Record.Exception(() =>
            {
                Subject(new[] { new JsonContentValidator() }).Validate("/api/products/1", OperationType.Get, "200", openApiDocument, response);
            });
